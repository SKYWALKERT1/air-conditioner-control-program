...
while True:
    ...
    if (islem == 'q'):
        ...
        time.sleep(1)
        print("Yetkili Servise Hoşgeldiniz Sizin icin 2 Elemanımız Vardır.Arıza Olustugunda Onlara E_mail'den ulaşabilirsiniz.")
        time.sleep(2)
        class Yetkili_kisi1:
         def __init__(self,adi,soyadi,e_mail):
             self.adi=adi
             self.soyadi=soyadi
             self.e_mail=e_mail
        class Yetkili_kisi2(Yetkili_kisi1):
         def __init__(self, adi, soyadi, e_mail):
             super().__init__(adi, soyadi, e_mail)
        Hasan = Yetkili_kisi1('Hasan','Yazar','Hasan_yazarr@gmail.com')
        Furkan = Yetkili_kisi2('Furkan','Kaya','Furkan_kaya@gmail.com')
        print("Adı:",Hasan.adi,"Soyadı:",Hasan.soyadi,"e_mail:",Hasan.e_mail)
        print("Adı:",Furkan.adi,"Soyadı:",Furkan.soyadi,"e_mail:",Furkan.e_mail)
    elif (islem=='9'):
